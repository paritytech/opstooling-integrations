...
exports.getConfigOptsFromEnv = exports.setupCommonInstance = exports.bindLogger = exports.resolveSetup = exports.getInstance = void 0;
...
function getInstance(opts) {
    ...
    return Promise.resolve(new rest_1.Octokit({ authStrategy, auth, baseUrl: opts.apiEndpoint ?? "https://api.github.com", throttle }));
